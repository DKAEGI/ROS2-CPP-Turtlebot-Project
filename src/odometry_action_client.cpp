...
public:
  ...
  explicit Odometry_Action_Client(
    ...
    this->action_client_timer_ = this->create_wall_timer(
        ...
        std::bind(&Odometry_Action_Client::send_goal, this));
  }
  ...
  void send_goal() {
    ...
    send_goal_options.goal_response_callback =
        std::bind(&Odometry_Action_Client::goal_response_callback, this, _1);

    send_goal_options.feedback_callback =
        std::bind(&Odometry_Action_Client::feedback_callback, this, _1, _2);

    send_goal_options.result_callback =
        std::bind(&Odometry_Action_Client::result_callback, this, _1);
...
}; // class Odometry_Action_Client


int main(int argc, char **argv) {
  rclcpp::init(argc, argv);
  auto action_client = std::make_shared<Odometry_Action_Client>();
